...
| Driver out | `$G<lat>,<lon>` on `succorfish/tx` | `std_msgs/String` | modem position after lever-arm transform; lat/lon at 7 decimal places (`ascii_on_air` digits, not DCCL — [proto/README.md](../../proto/README.md)) |
